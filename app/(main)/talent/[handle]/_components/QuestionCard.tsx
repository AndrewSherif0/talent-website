...
const CARD = "#0D1623", BORDER = "rgba(0,255,163,0.15)", MUTED = "#A8B3C2";
...
export default function QuestionCard() {
  return (
    <div style={{ backgroundColor: CARD, border: `1px solid ${BORDER}`, borderRadius: 16, padding: 22, textAlign: "center" }}>
      ...
      <h3 style={{ color: "#fff", fontSize: 15, fontWeight: 800, marginBottom: 6 }}>اسأل الموديل</h3>
      <p style={{ color: MUTED, fontSize: 12, marginBottom: 16 }}>لديك سؤال؟ تواصل مع Maya مباشرةً</p>
