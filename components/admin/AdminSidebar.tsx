...
import {
  ...
  Star, ShieldCheck, Settings, LogOut, X, User, ChevronLeft, ChevronRight,
} from "lucide-react";
    ...
    <>
      ...
      >
        ...
        <button
          ...
          onMouseEnter={e => { (e.currentTarget as HTMLElement).style.backgroundColor = HOVER; (e.currentTarget as HTMLElement).style.color = "#fff"; }}
